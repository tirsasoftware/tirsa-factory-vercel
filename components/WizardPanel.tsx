...
export default function WizardPanel({ factoryId, onClose, monthlyLimit }: WizardPanelProps) {
  ...
  async function send() {
    ...
    try {
      ...
      const body = await res.json() as { reply?: string; actions?: { tool: string; args: unknown; result: unknown }[]; error?: string };
