  ...
  return (
    <>
      ...
      <div style={{ display: "flex", height: "100vh" }}>
        <AppSidebar active={"notifications" as never} />

        <div style={{ flex: 1, overflowY: "auto", padding: "48px 24px" }}>
          <div style={{ maxWidth: 680, margin: "0 auto" }}>
            {/* Header */}
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 4 }}>
              <Bell size={28} style={{ color: "var(--mauve)" }} />
              <h1 style={{ fontSize: 28, fontWeight: 700, color: "var(--text)", margin: 0 }}>Notifications</h1>
            </div>
            <p style={{ color: "var(--subtext0)", fontSize: 14, marginBottom: 32, marginLeft: 40 }}>
              Configure where you receive notifications. Add integrations and fine-tune per event.
            </p>
