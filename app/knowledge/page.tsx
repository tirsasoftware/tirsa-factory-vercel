  ...
  return (
    <>
      ...
      <div style={{ display: "flex", height: "100vh" }}>
        <AppSidebar active={"knowledge" as any} />

        <div style={{ flex: 1, overflowY: "auto", padding: "48px 24px" }}>
          <div style={{ maxWidth: 680, margin: "0 auto" }}>
            {/* ── Header ─────────────────────────────────────────── */}
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 4 }}>
              <Brain size={28} style={{ color: "var(--mauve)" }} />
            ...
            <p style={{ color: "var(--subtext0)", fontSize: 14, marginBottom: 32, marginLeft: 40 }}>
              Reusable knowledge packs for AI agents. Create instances, add sources, and link to projects.
            </p>
