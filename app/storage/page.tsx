...
export default function StoragePage() {
  ...
  return (
    <div style={{ display: "flex", height: "100vh", fontFamily: "var(--font-sans)", color: "var(--text)", background: "var(--base)" }}>
      <AppSidebar active="storage" />
      <div style={{ flex: 1, overflowY: "auto" }}>
        <div style={{ maxWidth: 680, margin: "0 auto", padding: "32px 24px 80px" }}>

          {/* Header */}
          <div style={{ marginBottom: 24 }}>
            <h1 style={{ fontSize: 22, fontWeight: 700, fontFamily: "var(--font-heading)", marginBottom: 6 }}>Storage</h1>
            <p style={{ fontSize: 13, color: "var(--subtext0)", maxWidth: 520, marginBottom: 0 }}>
